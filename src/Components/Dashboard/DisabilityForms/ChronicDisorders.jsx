...
const ChronicDisorders = ({userData}) => {
 const [formData, setFormData] = useState({
  ...
  const handleInputChange = (e) => {
    ...
    if (name.startsWith("summary")) {
      setFormData((prev) => ({
        ...prev,
        summaryFindings: {
          ...prev.summaryFindings,
          [name.replace('summary', '')]: value, // Remove 'summary' prefix for key
        },
      }));
    } else if (type === "radio") { // Handle radio buttons specifically
      setFormData((prev) => ({
        ...prev,
  ...
  const handleDisabilityRatingChange = (e) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow-md">
          ...
          <div className="mb-4">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="py-3 px-4 border-b border-gray-300 text-sm text-gray-700">
                      <input
                        ...
                        name="summaryDateOfInjuryOnset"
                        value={formData.summaryFindings.dateOfInjuryOnset}
                        onChange={handleInputChange}
                  ...
                  <tr>
                    ...
                    <td className="py-3 px-4 border-b border-gray-300 text-sm text-gray-700">
                      <input
                        type="date" // Changed to type="date"
                        name="summaryDateOfLastIntervention"
                        value={formData.summaryFindings.dateOfLastIntervention}
                        onChange={handleInputChange}
                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td className="py-3 px-4 border-b border-gray-300 text-sm text-gray-700">
                      <input
                        type="text"
                        name="summaryListInterventions"
                        value={formData.summaryFindings.listInterventions}
                        onChange={handleInputChange}
                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td className="py-3 px-4 border-b border-gray-300 text-sm text-gray-700">
                      <input
                        type="text"
                        name="summaryCauseOfDisability"
                        value={formData.summaryFindings.causeOfDisability}
                        onChange={handleInputChange}
                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                      />
                    </td>
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-3">REGION (s) AFFECTED</h3>
            <textarea
                    ...
                    <tr key={area}>
                      ...
                      <td className="py-3 px-4 border-b border-r border-gray-300 text-sm text-gray-700">
                        <input
                          ...
                          onChange={(e) =>
                            handleAssessmentDetailChange(index, "findings", e.target.value)
                          }
                      ...
                      {impairmentLevels.map((level) => (
                        ...
                        >
                          <input
                            ...
                            value={level}
                            checked={formData.assessmentDetails[index].score === level}
                            onChange={() => handleScoreCheckboxChange(index, level)}
                      ...
                      <td className="py-3 px-4 border-b border-gray-300 text-sm text-gray-700">
                        <input
                          ...
                          onChange={(e) =>
                            handleAssessmentDetailChange(index, "remarks", e.target.value)
                          }
                          className="mt-1 block w-full px-1 py-0.5 border-0 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        />
                      </td>
              ...
              <table className="min-w-full bg-white border border-gray-300">
                ...
                <tbody>
                  {functionParticipationAreas.map((area, index) => (
                    <tr key={area}>
                      <td className={`py-3 px-4 border-b border-r border-gray-300 text-sm text-gray-700 ${area.includes('Score For Function') ? 'font-semibold bg-gray-50' : ''}`}>
                        {area}
                      </td>
                      {difficultyLevels.map((level) => (
                        <td
                        ...
                        >
                          <input
                            type="radio"
                            name={`${area.replace(/[^a-zA-Z0-9]/g, '')}Difficulty`}
                            value={level}
                            checked={formData.functionAndParticipationRestrictions[index].score === level}
                            onChange={() => handleFunctionParticipationScoreChange(index, level)}
                            className="form-checkbox h-4 w-4 text-blue-600 focus:ring-blue-500"
                          />
                        </td>
                      ))}
                      <td className="py-3 px-4 border-b border-gray-300 text-sm text-gray-700">
                        <input
                          ...
                          value={formData.functionAndParticipationRestrictions[index].remarks}
                          onChange={(e) =>
                            handleFunctionParticipationChange(index, "remarks", e.target.value)
                          }
                          className="mt-1 block w-full px-1 py-0.5 border-0 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        />
                      </td>
