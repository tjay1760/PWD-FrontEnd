      ...
      <div className="grid grid-cols-4 gap-6 mb-6">
        <div className="bg-white rounded-lg p-6 border border-gray-400">
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-full flex items-center justify-center">
              <img src={Tickheart} alt="Completed" className="w-full text-green-600" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 border border-gray-400">
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-full flex items-center justify-center">
              <img src={HeartSearch} alt="Pending" className="w-full text-orange-600" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 border border-gray-400">
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-full flex items-center justify-center">
              <img src={LinearLovely} alt="Flagged" className="w-full text-blue-600" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 border border-gray-400">
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-full flex items-center justify-center">
              <img src={LinearLike} alt="Approval Rate" className="w-full text-green-600" />
            </div>
          </div>
        </div>
      </div>
